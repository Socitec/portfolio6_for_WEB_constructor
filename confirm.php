  ...
  <main>
    <section class="confirm" id="confirm">
      <div class="container">
        ...
        <div class="table-responsive confirmBox">
          <table class="table">
          ...
          <div class="buttonBox">
            <div class="buttonarea">
              <form action="index.php" method="post" class="action">
                <button type="submit" class="button btn-secondary">戻る</button>
              </form>
              <form action="complete.php" method="post" class="action">
                <!-- 完了ページへ渡すトークンの隠しフィールド -->
                <input type="hidden" name="ticket" value="<?php echo h($ticket); ?>">
                <button type="submit" class="button btn-success">送信する</button>
              </form>
              <div class="clear"></div>
            </div>
          </div>
