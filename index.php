  ...
  <header class="header width100" id="scrollArea">
    <div class="container width100">
      ...
      <div class="headerMenu navWrapper">
        <nav class="headerNav">
          <ul class="navList">
            <a class="goSection hoverChangeColor" href="#solution"><li class="navItem">提案</li></a>
            <a class="goSection hoverChangeColor" href="#profile" ><li class="navItem">自己紹介</li></a>
            <a class="goSection hoverChangeColor" href="#service" ><li class="navItem">サービス内容</li></a>
            <a class="goSection hoverChangeColor" href="#works" ><li class="navItem">実績</li></a>
            <a class="goSection hoverChangeColor" href="#order" ><li class="navItem">依頼の流れ</li></a>
            <a class="goSection hoverChangeColor" href="#contact" ><li class="navItem">お問い合わせ</li></a>
          </ul>
        </nav>
      </div>
    </div>
    ...
    <section class="topview" id="topview">
      <div class="container">
        <div class="content">
          ...
          <div class="top">
            <h1>あなたの会社のWEBサイト<br>
              <span class="underline">二人三脚で</span>育てていきます</h1>
          </div>
          <div class="limitedTime">
            <p>
              11月末までにご契約の方<span class="underline largeLetter">"期間限定"</span><br>
              公開後の修正を3か月間<br>
              <span class="underline largeLetter">追加料金なしで</span>行います
            </p>
            <div class="inquiryButton">
              <a class="goSection" href="#contact"><button class="button" type="button" name="button">まずは<span class="largeLetter">無料相談</span>の問い合わせ</button></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="solutions">
          ...
          <div class="solution3 item">
            ...
            <p>
              WEBサイトを構築したり、ECサイトを構築するには、一般的な制作会社では少なくとも30万円、場合によっては数100万円閣下ることもあります。<br>
              事業を始めたての方や、コロナで売り上げが落ちている方にとっては、家賃や給与の支払いで余裕がないことも多々あります。<br>
              そこで行政による<span class="underline">IT導入助成金</span>を使うことで、格安でプランを提案することができます。<br>
              導入例として、100万円程度かかるECサイト構築費用をわずか<span class="underline">10万円</span>の負担で実施することができました。
              WEB関連の投資を後回しにしている方、どうぞお気軽にご相談ください。<p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div class="worksBox">
              <div class="website">
                ...
                <div class="websiteBox">
                  ...
                  <div class="clip item">
                    <a class="link" href="https://doclip.net/">
                    ...
                    <p>HTML、CSS、JavaScript(jQuery)、PHP</p>
                    <h5>力を入れた部分</h5>
                    <p>スマホ用のレスポンシブデザインでは、指で押しやすい位置にメニューボタンを設置するなど、ユーザビリティにこだわりました。
                    </p>
                  </div>
